...
function CourseDetails() {
  ...
  return (
    <>
          ...
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            >
              ...
              <div className="text-md flex flex-wrap items-center gap-2">
                <span className="text-red-700">{avgReviewCount}</span>
            ...
            <div className="flex w-full flex-col gap-4 border-y border-y-gray-600 py-4 lg:hidden">
              <p className="space-x-3 pb-4 text-3xl font-semibold text-amber-600">
                Rs. {price}
              </p>
      ...
      <div className="mx-auto box-content px-4 text-start text-amber-700 lg:w-[1260px]">
        <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
          {/* What will you learn section */}
          <div className="my-8 border border-black p-8">
            <p className="text-3xl font-semibold text-white">What you'll learn</p>
            <div className="mt-5 text-amber-950 text-2xl">
          ...
          <div className="max-w-[830px] ">
            ...
            <div className="mb-12 py-4">
              ...
              <div className="flex items-center gap-4 py-4">
                ...
                />
                <p className="text-lg text-fuchsia-950">{`${instructor.firstName} ${instructor.lastName}`}</p>
              </div>

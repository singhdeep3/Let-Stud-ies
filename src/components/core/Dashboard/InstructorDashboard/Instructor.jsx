  ...
  return (
    <div className="mx-auto ml-9">
      ...
      {loading ? (
        ...
        <div>
          <div className="my-4 flex  space-x-4">
            ...
            {totalAmount > 0 || totalStudents > 0 ? (
              ...
              <div className="flex-1 rounded-md bg-gray-700 p-6">
            ...
            {/* Total Statistics */}
            <div className="flex min-w-[250px] flex-col rounded-md bg-gray-700 p-6">
        ...
        <div className="mt-20 rounded-md bg-gray-700 p-6 py-20">

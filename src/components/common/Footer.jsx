        ...
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-gray-300">
          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-gray-100 pl-3 lg:pr-5 gap-3">
              ...
              <div className="flex flex-col gap-2">
                {["About", "Careers", "Affiliates"].map((ele, i) => {
                  return (
                    <div
                      key={i}
                      className="text-[14px] cursor-pointer hover:text-blue-400 transition-all duration-200"
                    >
            ...
            <div className="w-[48%] lg:w-[30%] mb-7 lg:pl-0">
              ...
              <div className="text-[14px] cursor-pointer hover:text-blue-400 transition-all duration-200 mt-2">
                ...
                <div
                  ...
                  className={` ${
                    BottomFooter.length - 1 === i
                      ? "cursor-pointer hover:text-gray-500 transition-all duration-200"
                      : "border-r border-gray-500 cursor-pointer hover:text-gray-500 transition-all duration-200"
                  } px-3 `}
                >
